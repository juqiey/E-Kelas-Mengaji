              ...
              <div class="card shadow-sm">
                ...
                <div class="card-body">
                  <p class="mb-0">
                    ...
                    <?php echo $teacher['teacherusername']; ?>
                  </p>
                  <p class="mb-0">
                ...
                <div class="card-body pt-0">
                  <table class="table table-bordered">
                    ...
                    <tr>
                      ...
                      <td width="2%">:</td>
                      <td>
                        <?php echo htmlspecialchars($teacher['teacheraddress']); ?>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td width="2%">:</td>
                      <td>
                        <?php echo htmlspecialchars($teacher['teacherphoneno']); ?>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td width="2%">:</td>
                      <td>
                        <?php echo htmlspecialchars($teacher['teacheremail']); ?>
                      </td>
                    </tr>
                  </table>
                </div>
                ...
                <div class="card-body pt-0">
                  <table class="table table-bordered">
                    <tr>
                      ...
                      <td width="2%">:</td>
                      <td>
                        <?php echo htmlspecialchars($teacher['teacherbank']); ?>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td width="2%">:</td>
                      <td>
                        <?php echo htmlspecialchars($teacher['teacheraccountno']); ?>
                      </td>
                    </tr>
                  </table>
                </div>
