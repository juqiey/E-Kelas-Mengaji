                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form action="../controller/register_exec.php" method="POST" enctype="multipart/form-data">
                                            <div class="row mb-3">
                                            <h3 class="text-left font-weight-light mb-3">Maklumat Pelajar</h3>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating">
                                                        <input class="form-control" name="dob" id="inputLastName" type="date" placeholder="" />
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating">
                                                        <input class="form-control" name="phoneno" id="phone" type="text" placeholder=""/>
                                                        <label for="phone">No. Telefon</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" name="address" id="inputAddress" type="text" placeholder="" />
                                                <label for="inputAddress">Alamat Penuh</label>
                                            </div>
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating">
                                                        <input class="form-control" name="postcode" id="poskod" type="number" placeholder="" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}"/>
                                            ...
                                            <h3 class="text-left font-weight-light my-4">Maklumat Ibu/Bapa/Penjaga</h3>
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" name="parentname" id="inputFirstName" type="text" placeholder="Enter your first name" />
                                                        <label for="inputFirstName">Nama Penuh</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-floating">
                                                        <input class="form-control" id="phone" name="parentphoneno" type="tel" placeholder="" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}"/>
                                                        <label for="phone">No. Telefon</label>
                                                    </div>
                                                </div>
                                            </div>
