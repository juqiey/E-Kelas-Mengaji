...
CREATE TABLE `class`  (
  ...
  `classdescription` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `classquota` int(11) NULL DEFAULT NULL,
...
CREATE TABLE `teacher`  (
  ...
  `teacherbank` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `teachernumaccount` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
